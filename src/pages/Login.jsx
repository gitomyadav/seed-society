    ...
    <div className="auth-page">
      <div className="auth__visual">
        <div className="auth__visual-content">
          ...
          <h2 className="auth__visual-title">Welcome back</h2>
          <p className="auth__visual-text">
            Continue your learning journey. Your notes, progress, and classes are waiting for you.
          </p>
      ...
      <div className="auth__form-side">
        <div className="auth__form-container">
          ...
          <div className="auth__form-header">
            <h1 className="auth__form-title">Sign in to your account</h1>
          ...
          <p className="auth__terms" style={{ marginTop: 'var(--space-6)', textAlign: 'center' }}>
